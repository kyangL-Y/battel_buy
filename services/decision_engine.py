...
def build_sales_demo_content(
    ...
    return {
        ...
        "hero": {
            ...
            "description": "先给老板看风险和机会，再展示采购建议和交付路径，不再让客户自己解释一堆表。",
            "primary_cta": "进入老板驾驶舱",
            "secondary_cta": "查看套餐",
        },
        "proof_points": [
        ...
        "scenes": [
            {"title": "老板驾驶舱", "description": "先展示今天该关注什么。", "highlight": "3 分钟说清产品价值"},
            {"title": "经营信号", "description": "展示为什么现在买、为什么现在不买。", "highlight": "规则优先，可解释"},
            {"title": "菜单采购增强", "description": "从采购清单升级成采购决策。", "highlight": "可直接进入报价承接"},
        ],
        "storyline": [
            "先讲今天的机会和风险。",
            "再落到单品和菜单，证明建议真实可用。",
        ...
        "items": [
            {
                ...
                "target": "顾问型销售 / 单城市客户",
                "recommended": False,
                "features": ["老板驾驶舱", "经营信号概览", "菜单采购演示", "标准讲解脚本"],
                "cta": "适合快速试点和验证成交意向",
            },
            {
                "name": "经营决策版",
